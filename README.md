...
ML-инженер с опытом разработки production-систем для закрытых контуров.  
Специализируюсь на мультиагентных LLM-системах, RAG-пайплайнах и оптимизации инференса локальных моделей.  
Умею доводить ML-ядро до продукта — от архитектуры до десктопного интерфейса.
